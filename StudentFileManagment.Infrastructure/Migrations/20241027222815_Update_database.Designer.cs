...
namespace StudentFileManagment.Infrastructure.Migrations
{
    ...
    [Migration("20241027222815_Update_database")]
            ...
            modelBuilder.Entity("StudentFileManagement.Domain.Education", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b103f073-0a33-44c3-a96f-6d976d154963"),
                            Name = "СПО"
                        },
                        new
                        {
                            Id = new Guid("8682d938-9cac-4bbb-a45d-88608c6b2794"),
                            Name = "Бакалавриат"
                        },
                        new
                        {
                            Id = new Guid("4ea0a665-2666-4a8a-83cf-c1ec050635f3"),
                            Name = "Магистратура"
                        });
                });
            ...
            modelBuilder.Entity("StudentFileManagement.Domain.Institution", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a10b888-5619-4e81-a014-bff5647ec504"),
                            Name = "ВГЛТУ"
                        });
                });
